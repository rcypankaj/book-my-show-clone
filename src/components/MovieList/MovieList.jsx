...
import PosterSlider from "../Poster/PosterSlider";

const MovieList = ({ selectedMovieData }) => {
  ...
  useEffect(() => {
    const requestSimilarMovies = async () => {
      const getSimilarMovies = await axios.get(`/movie/${movieId}/similar`);
  ...
  }, [movieId, setMovie, selectedMovieData]);
