...
const NavSm = () => {
  ...
  return (
    <div className="text-white flex justify-between">
      ...
      <div
        className={`${searchClasses.searchBackdrop} hidden fixed top-0 left-0 z-20 h-screen w-screen bg-black bg-opacity-80 transition-opacity duration-200 ease-linear`}
        onClick={searchBackdropHandler}
      ></div>
      <div
...
const NavLg = () => {
  ...
  const handleClickLogin = () => {
    setLoginClasses({ backDrop: "backdrop", modal: "modal" });
  };
  ...
  return (
    <Fragment>
      <div className="container flex px-4 justify-between h-10">
        <div className="flex w-1/2 gap-3 mt-1">
          <div className="w-32">
            <Link to="/">
              <svg
                viewBox="0 0 88 26"
          ...
          <div className="w-full">
            <form
              className="flex items-center w-full gap-3 bg-white px-3 py-1 rounded-t-md "
              onSubmit={searchMovieHandler}
            >
              <input
                type="search"
            ...
            <ul
              ...
              style={{
                height: !isLoading && fetchedMovies.length > 5 ? "12rem" : "",
                overflowY:
                  !isLoading && fetchedMovies.length > 5 ? "scroll" : "",
              }}
            >
              {isLoading ? (
                <li className="py-1 px-3">Loading...</li>
        ...
        <div className="flex items-center gap-5">
          ...
          <Link
            to="/plays"
            className="text-gray-200 text-base flex items-center hover:text-white"
          >
            Plays
          </Link>
          {!isLoggedIn && (
